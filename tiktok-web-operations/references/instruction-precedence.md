...
The executor applies a newer direction, duration, intensity, or authorized lane
at the next safe item boundary without a second confirmation. Stop/revocation
interrupts before the next mutation. Expanded authority is used only when the
latest user wording actually grants it.
